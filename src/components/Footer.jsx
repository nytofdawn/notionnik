...
export default function Footer() {
    return (
        <footer className="bg-gradient-to-r from-green-900 to-green-950 border-t border-white/10 text-white py-10 px-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="flex flex-col items-center md:items-start gap-1">
                    ...
                    <p className="text-green-300 text-sm mt-2">© 2026 Notionnik. All rights reserved.</p>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                    {[
                        ...
                        <Link
                            key={link.label}
                            to={link.to}
                            className="text-green-200/80 hover:text-white transition-colors duration-200"
                        >
                            {link.label}
                        </Link>
                    ))}
                ...
                <div className="flex flex-col items-center gap-3">
                    <p className="text-green-300 text-sm font-semibold tracking-wide uppercase">Follow Us</p>
                    <div className="flex gap-4">
                        ...
                        <a
                            ...
                            className="bg-white/10 hover:bg-blue-600 border border-white/20 rounded-xl p-3 transition-all duration-200 hover:-translate-y-1 hover:border-blue-500"
                            aria-label="Facebook"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-white/10 hover:bg-blue-700 border border-white/20 rounded-xl p-3 transition-all duration-200 hover:-translate-y-1 hover:border-blue-600"
                            aria-label="LinkedIn"
                        >
                            <svg className="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-white/10 hover:bg-green-600 border border-white/20 rounded-xl p-3 transition-all duration-200 hover:-translate-y-1 hover:border-green-500"
                            aria-label="Upwork"
                        >
                            <svg className="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
