export default function AboutUs() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#00F0FF] to-[#B0E0E6] py-16 px-6">

            {/* Header */}
            <div className="text-center mb-16 max-w-3xl mx-auto">
                <span className="inline-block bg-white/10 border border-black/20 text-green-800 text-sm font-semibold px-4 py-1 rounded-full mb-4 tracking-wide">
                    Who We Are
                </span>
                <h1 className="text-5xl font-bold text-green-950 mb-5 tracking-tight">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
                {values.map((v) => (
                    ...
                    >
                        ...
                        <h3 className="text-blue-500 font-bold text-lg">{v.title}</h3>
            ...
            <div className="max-w-6xl mx-auto mb-16">
                <h2 className="text-black font-bold text-2xl mb-8 text-center">👥 Meet the Team</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {team.map((member) => (
                        ...
                        >
                            ...
                            <div>
                                <h2 className="text-green-950 font-bold text-xl">{member.name}</h2>
                                ...
                                <p className="text-black-200/80 text-sm leading-relaxed">{member.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
